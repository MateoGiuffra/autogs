...
# Obtener la versión de Google Chrome e instalar la versión correspondiente de ChromeDriver
   && GOOGLE_CHROME_VERSION=$(google-chrome-stable --version | awk '{print $3}') \
   && CHROME_DRIVER_VERSION=$(curl -sSL https://chromedriver.storage.googleapis.com/LATEST_RELEASE_${GOOGLE_CHROME_VERSION}) \
